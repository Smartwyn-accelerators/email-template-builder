...
import com.fastcode.email.emailbuilder.domain.emailvariable.IEmailVariableManager;
...
import com.fastcode.email.emailbuilder.domain.model.QEmailVariableEntity;
...
public class EmailVariableAppService implements IEmailVariableAppService {
	...
	public List<EmailMergeFieldEntity> getMergeFieldsMapping(Long id) {
		return emailMergeFieldEntityRepo.findByEmailVariableId(id);
	}
}
